...
public class Dot extends Damage_Methods{
	Double aot_damage;
	Double aot_over_time;
	...
	public Double getAot_damage() {
		return aot_damage;
	}
	public void setAot_damage(Double aot_damage) {
		this.aot_damage = aot_damage;
	}
	public Double getAot_over_time() {
		return aot_over_time;
	}
	public void setAot_over_time(Double aot_over_time) {
	...
	public void conversion(MainDamage mainDamage)
	{
		...
		this.aot_damage = mainDamage.aot_damage + 0.0;
		this.aot_over_time = mainDamage.aot_over_time + 0.0;
...
//			this.traps[i] = mainDamage.traps[i] >= 0? 1.0 + ((double) mainDamage.traps[i]/100): 1.0 + ((double)mainDamage.traps[i]/100);
	...
	public Double[] calculate_damage(MainDamage mainDamage) {
		...
		Double[] dam = {aot_damage, aot_over_time };
